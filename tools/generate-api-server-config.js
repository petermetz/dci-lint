...
const main = async () => {
  ...
  const apiServerCmd = `node ./pkg/cmd-api-server/dist/lib/main/typescript/cmd/api.js --config-file=${config.configFile}`;
  console.log(
    `You can start the DCI Lint API server with ${config.configFile} by executing this from the project root:`
  );
